...
class Management:
    ...
    def AddStudent(self):
        ...
        self.contact = Label(self.frame_1, text="Student ID", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=40,y=310)
    ...
    '''Get the student ID to show a student details'''
    def GetContact_View(self):
        self.ClearScreen()

        self.getInfo = Label(self.frame_1, text="Enter Student ID", font=(self.font_2, 18, "bold"), bg=self.color_1).place(x=140,y=70)
    ...
    '''To update a student details, get the student ID'''
    ...
    '''Get the student ID to delete a student record'''
    ...
    '''
    Checks whether the student ID is available or not. If available, 
    the function calls the 'ShowDetails' function to display the result.
    '''
    def CheckContact_View(self):
        if self.getInfo_entry.get() == "":
            messagebox.showerror("Error!", "Please enter your student ID",parent=self.window)
        else:
            try:
                ...
                if row == None:
                    messagebox.showerror("Error!","Student ID number doesn't exists",parent=self.window)
                else:
    ...
    '''
    Checks whether the student ID number is available or not. If available, 
    ...
    def CheckContact_Update(self):
        if self.getInfo_entry.get() == "":
            ...
            try:
                ...
                if row == None:
                    messagebox.showerror("Error!","student ID doesn't exists",parent=self.window)
                else:
    ...
    def GetUpdateDetails(self, row):
        ...
        contact = Label(self.frame_1, text="Student ID", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=40,y=310)
    ...
    def UpdateDetails(self, row):
        if self.name_entry.get() == "" or self.surname_entry.get() == "" or self.course_entry.get() == "" or self.subject_entry.get() == "" or self.year_entry.get() == "" or self.age_entry.get() == "" or self.gender_entry.get() == "" or self.birth_entry.get() == "" or self.email_entry.get() == "":
            ...
            try:
                ...
                if row==None:
                    messagebox.showerror("Error!","The student ID doesn't exists",parent=self.window)
                else:
    ...
    def Submit(self):
        if self.name_entry.get() == "" or self.surname_entry.get() == "" or self.course_entry.get() == "" or self.subject_entry.get() == "" or self.year_entry.get() == "" or self.age_entry.get() == "" or self.gender_entry.get() == "" or self.birth_entry.get() == "" or self.contact_entry.get() == "" or self.email_entry.get() == "":
            ...
            try:
                ...
                if row!=None:
                    messagebox.showerror("Error!","The student ID is already exists, please try again with another number",parent=self.window)
                else:
